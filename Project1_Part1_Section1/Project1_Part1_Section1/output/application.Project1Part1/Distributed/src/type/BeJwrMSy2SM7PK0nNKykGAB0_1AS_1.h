...
#ifndef BEJWRMSY2SM7PK0NNKYKGAB0_1AS_1_H_
#define BEJWRMSY2SM7PK0NNKYKGAB0_1AS_1_H_
...
public:
    ...
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), contents_(ot.contents_) 
      { constructPayload(ot); }
    SELF(const contents_type & _contents) : Tuple(), contents_(_contents) { }
...
#undef SELF
#endif // BEJWRMSY2SM7PK0NNKYKGAB0_1AS_1_H_ 
