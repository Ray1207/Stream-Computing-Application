...
#ifndef BEJWRMCO0ZCNMSY3ONC3PL0OPBGAYBGYT_H_
#define BEJWRMCO0ZCNMSY3ONC3PL0OPBGAYBGYT_H_
...
#define SELF BeJwrMco0zcnMSy3ONC3PL0opBgAybgYt
...
public:
    ...
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), lines_(ot.lines_), words_(ot.words_) 
      { constructPayload(ot); }
    SELF(const lines_type & _lines, const words_type & _words) : Tuple(), lines_(_lines), words_(_words) { }
...
#undef SELF
#endif // BEJWRMCO0ZCNMSY3ONC3PL0OPBGAYBGYT_H_ 
