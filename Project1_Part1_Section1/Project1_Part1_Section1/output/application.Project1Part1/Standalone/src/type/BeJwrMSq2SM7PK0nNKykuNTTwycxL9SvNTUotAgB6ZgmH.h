// t2s8contentsu10LineNumber


#ifndef BEJWRMSQ2SM7PK0NNKYKUNTTWYCXL9SVNTUOTAGB6ZGMH_H_
#define BEJWRMSQ2SM7PK0NNKYKUNTTWYCXL9SVNTUOTAGB6ZGMH_H_
...
#define SELF BeJwrMSq2SM7PK0nNKykuNTTwycxL9SvNTUotAgB6ZgmH
...
public:
    ...
    typedef SPL::rstring contents_type;
    typedef SPL::uint32 LineNumber_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), contents_(ot.contents_), LineNumber_(ot.LineNumber_) 
      { constructPayload(ot); }
    SELF(const contents_type & _contents, const LineNumber_type & _LineNumber) : Tuple(), contents_(_contents), LineNumber_(_LineNumber) { }
    ...
    contents_type & get_contents() { return contents_; }
    const contents_type & get_contents() const { return contents_; }
    void set_contents(const contents_type & _contents) { contents_ = _contents; }
    
    LineNumber_type & get_LineNumber() { return LineNumber_; }
    const LineNumber_type & get_LineNumber() const { return LineNumber_; }
    void set_LineNumber(const LineNumber_type & _LineNumber) { LineNumber_ = _LineNumber; }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::tr1::hash<contents_type >()(contents_);
        s = 37 * s + std::tr1::hash<LineNumber_type >()(LineNumber_);
        return s;
    }
    ...
    size_t getSerializedSize() const
    {
        size_t size = sizeof(SPL::uint32);
           size += contents_.getSerializedSize();
    ...
    { 
        contents_ = ot.contents_;
        LineNumber_ = ot.LineNumber_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    void swap(SELF & ot) 
    { 
        std::swap(contents_, ot.contents_);
        std::swap(LineNumber_, ot.LineNumber_);
...
#undef SELF
#endif // BEJWRMSQ2SM7PK0NNKYKUNTTWYCXL9SVNTUOTAGB6ZGMH_H_ 
