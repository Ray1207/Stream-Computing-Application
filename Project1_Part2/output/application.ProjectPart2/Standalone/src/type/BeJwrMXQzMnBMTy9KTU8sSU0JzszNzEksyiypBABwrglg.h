// t1F20AggregatedSimilarity


#ifndef BEJWRMXQZMNBMTY9KTU8SSU0JZSZNZEKSYIYPBABWRGLG_H_
#define BEJWRMXQZMNBMTY9KTU8SSU0JZSZNZEKSYIYPBABWRGLG_H_
...
#define SELF BeJwrMXQzMnBMTy9KTU8sSU0JzszNzEksyiypBABwrglg
...
public:
    ...
    typedef SPL::float64 AggregatedSimilarity_type;

    enum { num_attributes = 1 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), AggregatedSimilarity_(ot.AggregatedSimilarity_) 
      { constructPayload(ot); }
    SELF(const AggregatedSimilarity_type & _AggregatedSimilarity) : Tuple(), AggregatedSimilarity_(_AggregatedSimilarity) { }
    ...
    AggregatedSimilarity_type & get_AggregatedSimilarity() { return AggregatedSimilarity_; }
    const AggregatedSimilarity_type & get_AggregatedSimilarity() const { return AggregatedSimilarity_; }
    void set_AggregatedSimilarity(const AggregatedSimilarity_type & _AggregatedSimilarity) { AggregatedSimilarity_ = _AggregatedSimilarity; }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::tr1::hash<AggregatedSimilarity_type >()(AggregatedSimilarity_);
        return s;
    }
    ...
    { 
        AggregatedSimilarity_ = ot.AggregatedSimilarity_; 
        assignPayload(ot);
        return *this; 
    }
    ...
    void swap(SELF & ot) 
    { 
        std::swap(AggregatedSimilarity_, ot.AggregatedSimilarity_);
...
private:
    ...
    AggregatedSimilarity_type AggregatedSimilarity_;
...
#undef SELF
#endif // BEJWRMXQZMNBMTY9KTU8SSU0JZSZNZEKSYIYPBABWRGLG_H_ 
