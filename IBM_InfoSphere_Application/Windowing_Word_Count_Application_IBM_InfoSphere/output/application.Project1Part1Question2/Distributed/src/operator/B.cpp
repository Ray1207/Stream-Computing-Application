  ...
  _partitionCount(getContext().getMetrics().getCustomMetricByName("nCurrentPartitions"))
{
    ...
    _window.registerBeforeWindowFlushHandler(this);
        ...
        _window.registerWindowSummarizer<MY_OPERATOR::Tumbling$B>();
        ...
        WindowEventType::PartitionType const & partition) 
{
        ...
        MY_OPERATOR::Tumbling$B& summarizer =
            *static_cast<MY_OPERATOR::Tumbling$B*>(twindow.getSummarizer(partition));
...
bool MY_BASE_OPERATOR::globalIniter() {
    instantiators_.insert(std::make_pair("B",&initer));
    return true;
}
