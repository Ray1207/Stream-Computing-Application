...
#ifndef BEJWRMSO2LUMTKDGEUEYAMGKFDK_H_
#define BEJWRMSO2LUMTKDGEUEYAMGKFDK_H_
...
#define SELF BeJwrMSo2LUmtKDGEUEYAMgkFDk
...
public:
    ...
    typedef SPL::rstring text1_type;
    typedef SPL::rstring text2_type;

    enum { num_attributes = 2 } ;
    
    SELF() : Tuple() {}
    SELF(const Self & ot) : Tuple(), text1_(ot.text1_), text2_(ot.text2_) 
      { constructPayload(ot); }
    SELF(const text1_type & _text1, const text2_type & _text2) : Tuple(), text1_(_text1), text2_(_text2) { }
    ...
    text1_type & get_text1() { return text1_; }
    const text1_type & get_text1() const { return text1_; }
    void set_text1(const text1_type & _text1) { text1_ = _text1; }
    
    text2_type & get_text2() { return text2_; }
    const text2_type & get_text2() const { return text2_; }
    void set_text2(const text2_type & _text2) { text2_ = _text2; }
    ...
    {
        size_t s = 17;
        s = 37 * s + std::tr1::hash<text1_type >()(text1_);
        s = 37 * s + std::tr1::hash<text2_type >()(text2_);
        return s;
    }
    ...
    {
        size_t size = 0;
           size += text1_.getSerializedSize();
   size += text2_.getSerializedSize();
    ...
    void swap(SELF & ot) 
    { 
        std::swap(text1_, ot.text1_);
        std::swap(text2_, ot.text2_);
...
#undef SELF
#endif // BEJWRMSO2LUMTKDGEUEYAMGKFDK_H_ 
