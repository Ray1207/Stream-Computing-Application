...
{
    if (((((text1 == SPL::rstring(" ")) || (text1 == SPL::rstring("\r"))) || (text1 == SPL::rstring("\t"))) && (((text2 == SPL::rstring(" ")) || (text2 == SPL::rstring("\r"))) || (text2 == SPL::rstring("\t"))))) 
        {
            return SPL::float64(1.0);
        }
    if (((((text1 == SPL::rstring(" ")) || (text1 == SPL::rstring("\r"))) || (text1 == SPL::rstring("\t"))) || (((text2 == SPL::rstring(" ")) || (text2 == SPL::rstring("\r"))) || (text2 == SPL::rstring("\t"))))) 
        {
            return SPL::float64(0.0);
        }
    ...
    if ((::SPL::spl_cast<SPL::rstring, SPL::float64 >::cast(id$finalSim) == SPL::rstring("-nan"))) 
        return SPL::float64(0.0);
    return id$finalSim;
}
} 
